...
def RefreshExcel():
    ...
    df = pd.read_excel(r'/home/ds/Documents/LIFE/data/Life-cm/s/scamdoc.com-organic.Positions-fr-20230103-2023-01-04T11 29 26Z.xlsx')
...
def browser():
    ...
    input('/////////////////////////')
    driverinstance.get("https://www.fr.scamdoc.com")
    ...
    for item in list_indeed:
        ...
        if myDict["TITRE"] == "www.fr.scamdoc.fr":
        ...
        append_new_line(r'result-fr.scamdoc.txt', str(myDict))
        final_result.append(myDict)


    with open("res-fr.scamdoc.json", "wb") as writeJSON:
